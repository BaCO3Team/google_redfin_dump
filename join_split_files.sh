...
cat product/priv-app/DevicePersonalizationPrebuiltPixelBeta2020/DevicePersonalizationPrebuiltPixelBeta2020.apk.* 2>/dev/null >> product/priv-app/DevicePersonalizationPrebuiltPixelBeta2020/DevicePersonalizationPrebuiltPixelBeta2020.apk
rm -f product/priv-app/DevicePersonalizationPrebuiltPixelBeta2020/DevicePersonalizationPrebuiltPixelBeta2020.apk.* 2>/dev/null
